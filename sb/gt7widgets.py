...
class StartWindow(QWidget):
    def __init__(self):
        ...
        self.replayMode = QCheckBox("Replay mode (record laps during replays)")
        saLayout.addWidget(self.replayMode)

        self.replayMode.setChecked(settings.value("replayMode") in [ True, "true" ])
